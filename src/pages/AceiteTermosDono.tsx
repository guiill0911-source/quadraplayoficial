...
export default function AceiteTermosDono() {
  ...
  ref,
  {
    termosDonoAceitosEm: serverTimestamp(),
    versaoTermosDonoAceitos: TERMOS_VERSAO_ATUAL,
        ...
        <div style={styles.container}>
          <section style={styles.hero}>
            ...
            <div style={styles.heroContent}>
              <div style={styles.heroPill}>🤝 Termos de parceria</div>

              <h1 style={styles.heroTitle}>Confirme os termos de parceria da sua quadra</h1>

             <p style={styles.heroText}>
  Para continuar como parceiro no Quadra Play, precisamos confirmar que você
  leu e aceitou a versão atual dos Termos de Parceria para proprietários de
  quadras.
</p>

              <div style={styles.infoRow}>
                <div style={styles.infoChip}>Versão atual: {TERMOS_VERSAO_ATUAL}</div>
<div style={styles.infoChip}>Parceiros / Donos</div>
<div style={styles.infoChip}>Aceite necessário</div>
  ...
  Revise o documento abaixo e confirme o aceite para continuar usando
  o Quadra Play como parceiro com segurança e transparência.
</p>

              <div style={styles.linksWrap}>
                <Link to="/termos-dono?from=aceite-termos-dono"style={styles.linkCard}>
                  <p style={styles.linkTitle}>Ler Termos de Parceria</p>
                  <p style={styles.linkText}>
  Entenda as regras da parceria, período de teste, comissão, responsabilidades
  do parceiro e medidas operacionais da plataforma.
</p>
                </Link>
              ...
              <div style={styles.checkboxBox}>
                <label style={styles.checkboxLabel}>
                  ...
                  <span style={styles.checkboxText}>
                    Li e aceito os Termos de Parceria para proprietários de quadras.
                    <span style={styles.checkboxMuted}>
  Ao continuar, seu aceite será registrado na sua conta com a
  versão atual do documento de parceria.
</span>
                  </span>
                </label>
              </div>
              ...
              <div style={styles.actions}>
                ...
                <Link to="/termos-dono?from=aceite-termos-dono"style={styles.secondaryBtn}>
  Revisar termos
</Link>
              </div>
